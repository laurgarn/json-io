...
import com.cedarsoftware.io.sidesiterator.*;
...
public class ObjectWriter
{
	...
	public static class Stats {
        ...
        public Stats(int maxDepth, int maxQueueLength) {
    ...
    static class OneGoWriter implements Visitor {
        ...
        public SidesIterator startsVisit(Object object, int depth, String key, Accessor accessor, Object context)
        {
            ...
            if (config.isNeverShowingType()) {
                ...
                showsType = accessor == null || !Objects.equals(accessor.getFieldType(), object.getClass());
            }
            ...
            {
                autom.emitKey(config.isShortMetaKeys() ? "@r" : "@ref");
            ...
            if (codedId != null)
            {
                autom.emitKey(config.isShortMetaKeys() ? "@i" : "@id");
        ...
        SidesIterator onNull(Object object, String key)
        {
            ...
            if (key != null && config.isSkipNullFields()) {
                return emptyterator();
            }
...
//                        writeJsonObjectObject(jObj, showType);
        ...
        SidesIterator onPrimitive(Object object, Accessor accessor, Object context)
        {
            ...
            boolean allowsNanAndInfinity = config.isSkipNullFields();
            ...
            else if (object instanceof Long && config.isWriteLongsAsStrings())
            {
                if (showType)
                {
                    autom.emitObjectStart();
        ...
        SidesIterator fieldByField(Object object, boolean usesAKey)
        {
            ...
            return new PojoReflecionIterator(object, config);
        }
        ...
        public void visitNext(Object object, int depth, Object prevContext, Object nextContext)
        {
            ...
            {
                autom.emitKey(config.isShortMetaKeys() ? "@k" : "@keys");
                autom.emitArrayStart();
            }
    ...
    {
        return options.getTypeNameAlias(typeName);
    }
    ...
    private void driveIn(Object object, Visitor visitor)
    {
        ...
        while (!explicitStack.isEmpty())
        {
            ...
            if (top.it == null)
            {
                ...
                top.it = goAheadVisitor != null ? goAheadVisitor : fallbackSequence(theObj, config);
            }
    ...
    private static SidesIterator fallbackSequence(Object obj, WriteOptions config)
    {
        if (obj == null)
        {
            return emptyterator();
        ...
        return new PojoReflecionIterator(obj, config);
    }
